...
namespace MicrosoftTeamsDemo.cameraSelList
{
    ...
    public partial interface IcameraSelList 
    {
        ...
        /// </summary>
        MicrosoftTeamsDemo.cameraSelList.IcameraSelList cameraSelList { get; }
    }
    ...
    internal partial class cameraSelList : IcameraSelList, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            cameraSelList = new MicrosoftTeamsDemo.cameraSelList.cameraSelList(ComponentMediator, 42);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((MicrosoftTeamsDemo.cameraSelList.cameraSelList)cameraSelList).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((MicrosoftTeamsDemo.cameraSelList.cameraSelList)cameraSelList).RemoveDevice(device);
        }
        ...
        /// ComplexComponent cameraSelList
        /// </summary>
        public MicrosoftTeamsDemo.cameraSelList.IcameraSelList cameraSelList { get; private set; }
