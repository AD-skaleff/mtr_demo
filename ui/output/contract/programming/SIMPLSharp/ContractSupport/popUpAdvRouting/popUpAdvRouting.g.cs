...
namespace MicrosoftTeamsDemo.popUpAdvRouting
{
    ...
    public partial interface IpopUpAdvRouting 
    {
        ...
        /// </summary>
        MicrosoftTeamsDemo.popUpAdvRouting.IpopUpAdvRouteSources popUpAdvRouteSources { get; }

        /// <summary>
        /// ComplexComponent listItem_advDest
        /// </summary>
        MicrosoftTeamsDemo.popUpAdvRouting.IpopUpAdvRouteDest popUpAdvRouteDest { get; }
    }
    ...
    internal partial class popUpAdvRouting : IpopUpAdvRouting, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUpAdvRouting.popUpCloseBtn.Press
                /// popUpCloseBtn.Press
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUpAdvRouting.popUpCloseBtn.Selected
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            popUpAdvRouteSources = new MicrosoftTeamsDemo.popUpAdvRouting.popUpAdvRouteSources(ComponentMediator, 39);
            popUpAdvRouteDest = new MicrosoftTeamsDemo.popUpAdvRouting.popUpAdvRouteDest(ComponentMediator, 40);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((MicrosoftTeamsDemo.popUpAdvRouting.popUpAdvRouteSources)popUpAdvRouteSources).AddDevice(device);

            ((MicrosoftTeamsDemo.popUpAdvRouting.popUpAdvRouteDest)popUpAdvRouteDest).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((MicrosoftTeamsDemo.popUpAdvRouting.popUpAdvRouteSources)popUpAdvRouteSources).RemoveDevice(device);

            ((MicrosoftTeamsDemo.popUpAdvRouting.popUpAdvRouteDest)popUpAdvRouteDest).RemoveDevice(device);
        }
        ...
        /// </summary>
        public MicrosoftTeamsDemo.popUpAdvRouting.IpopUpAdvRouteSources popUpAdvRouteSources { get; private set; }

        /// <summary>
        /// ComplexComponent popUpAdvRouteDest
        /// </summary>
        public MicrosoftTeamsDemo.popUpAdvRouting.IpopUpAdvRouteDest popUpAdvRouteDest { get; private set; }
