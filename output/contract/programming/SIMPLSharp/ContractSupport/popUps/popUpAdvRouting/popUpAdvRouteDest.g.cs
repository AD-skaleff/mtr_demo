...
namespace MicrosoftTeamsDemo.popUps.popUpAdvRouting
{
    ...
    public partial interface IpopUpAdvRouteDestByItem
    {
        ...
        /// <summary>
        /// Event popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].advDestBtn.Press (from panel to Control System)
        /// </summary>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].advDestBtn.Selected Feedback
        /// </summary>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].advDestBtn.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
    ...
    public partial interface IpopUpAdvRouteDest : IpopUpAdvRouteDestByItem
    {
        ...
        /// <summary>
        /// Event popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].advDestBtn.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Items_1__advDestBtn_PressEvent;

        /// <summary>
        /// Event popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].advDestBtn.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Items_2__advDestBtn_PressEvent;

        /// <summary>
        /// Event popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].advDestBtn.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Items_3__advDestBtn_PressEvent;

        /// <summary>
        /// Event popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].advDestBtn.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Items_4__advDestBtn_PressEvent;

        /// <summary>
        /// Event popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].advDestBtn.Press (from panel to Control System)
        /// </summary>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].advDestBtn.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].advDestBtn.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].advDestBtn.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].advDestBtn.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].advDestBtn.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].advDestBtn.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].advDestBtn.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].advDestBtn.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].advDestBtn.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        ...
        /// <summary>
        /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].advDestBtn.Indirect Rich Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
    ...
    internal partial class popUpAdvRouteDest : IpopUpAdvRouteDest, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].listItem_advDestCONTRACT.advDestBtn.Press
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].advDestBtn.Press
                /// </summary>
                public const uint Items_0__advDestBtn_PressEvent = 1201;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].listItem_advDestCONTRACT.advDestBtn.Press
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].advDestBtn.Press
                /// </summary>
                public const uint Items_1__advDestBtn_PressEvent = 1202;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].listItem_advDestCONTRACT.advDestBtn.Press
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].advDestBtn.Press
                /// </summary>
                public const uint Items_2__advDestBtn_PressEvent = 1203;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].listItem_advDestCONTRACT.advDestBtn.Press
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].advDestBtn.Press
                /// </summary>
                public const uint Items_3__advDestBtn_PressEvent = 1204;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].listItem_advDestCONTRACT.advDestBtn.Press
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].advDestBtn.Press
                /// </summary>
                public const uint Items_4__advDestBtn_PressEvent = 1205;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].listItem_advDestCONTRACT.advDestBtn.Press
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].advDestBtn.Press
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].listItem_advDestCONTRACT.advDestBtn.Selected
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].advDestBtn.Selected
                /// </summary>
                public const uint Items_0__advDestBtn_SelectedState = 607;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].listItem_advDestCONTRACT.advDestBtn.Selected
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].advDestBtn.Selected
                /// </summary>
                public const uint Items_1__advDestBtn_SelectedState = 608;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].listItem_advDestCONTRACT.advDestBtn.Selected
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].advDestBtn.Selected
                /// </summary>
                public const uint Items_2__advDestBtn_SelectedState = 609;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].listItem_advDestCONTRACT.advDestBtn.Selected
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].advDestBtn.Selected
                /// </summary>
                public const uint Items_3__advDestBtn_SelectedState = 610;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].listItem_advDestCONTRACT.advDestBtn.Selected
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].advDestBtn.Selected
                /// </summary>
                public const uint Items_4__advDestBtn_SelectedState = 611;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].listItem_advDestCONTRACT.advDestBtn.Selected
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].advDestBtn.Selected
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].listItem_advDestCONTRACT.advDestBtn.IndirectRichText
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[0].advDestBtn.Indirect Rich Text
                /// </summary>
                public const uint Items_0__advDestBtn_IndirectRichTextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].listItem_advDestCONTRACT.advDestBtn.IndirectRichText
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[1].advDestBtn.Indirect Rich Text
                /// </summary>
                public const uint Items_1__advDestBtn_IndirectRichTextState = 2;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].listItem_advDestCONTRACT.advDestBtn.IndirectRichText
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[2].advDestBtn.Indirect Rich Text
                /// </summary>
                public const uint Items_2__advDestBtn_IndirectRichTextState = 3;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].listItem_advDestCONTRACT.advDestBtn.IndirectRichText
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[3].advDestBtn.Indirect Rich Text
                /// </summary>
                public const uint Items_3__advDestBtn_IndirectRichTextState = 4;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].listItem_advDestCONTRACT.advDestBtn.IndirectRichText
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[4].advDestBtn.Indirect Rich Text
                /// </summary>
                public const uint Items_4__advDestBtn_IndirectRichTextState = 5;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].listItem_advDestCONTRACT.advDestBtn.IndirectRichText
                /// popUps.popUpAdvRouting.popUpAdvRouteDest.Items[5].advDestBtn.Indirect Rich Text
                /// </summary>
