...
namespace MicrosoftTeamsDemo.widgetSrcATV
{

    /// <summary>
    /// widgetSrcATV
    /// </summary>
    public partial interface IwidgetSrcATV 
    {
        ...
        void atvBack_Selected(widgetSrcATVBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void atvPlay_Selected(widgetSrcATVBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void navReturn_Selected(widgetSrcATVBoolInputSigDelegate callback);
        ...
        void atvBack_IconURL(widgetSrcATVStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void atvPlay_IconURL(widgetSrcATVStringInputSigDelegate callback);
        ...
        /// </summary>
        MicrosoftTeamsDemo.widgetSrcATV.IatvDpad atvDpad { get; }
    }
    ...
    /// <param name="widgetsrcatv">The <see cref="IwidgetSrcATV"/> on which to apply the feedback.</param>
    public delegate void widgetSrcATVBoolInputSigDelegate(BoolInputSig boolInputSig, IwidgetSrcATV widgetsrcatv);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="stringInputSig">The <see cref="StringInputSig"/> joinInfo data.</param>
    /// <param name="widgetsrcatv">The <see cref="IwidgetSrcATV"/> on which to apply the feedback.</param>
    public delegate void widgetSrcATVStringInputSigDelegate(StringInputSig stringInputSig, IwidgetSrcATV widgetsrcatv);

    /// <summary>
    /// widgetSrcATV
    /// </summary>
    internal partial class widgetSrcATV : IwidgetSrcATV, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: widgetSrcATV.atvBack.Press
                /// atvBack.Press
                /// </summary>
                public const uint atvBack_PressEvent = 3;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: widgetSrcATV.atvPlay.Press
                /// atvPlay.Press
                /// </summary>
                public const uint atvPlay_PressEvent = 4;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: widgetSrcATV.navReturn.Press
                /// navReturn.Press
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: widgetSrcATV.atvBack.Selected
                /// atvBack.Selected
                /// </summary>
                public const uint atvBack_SelectedState = 3;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: widgetSrcATV.atvPlay.Selected
                /// atvPlay.Selected
                /// </summary>
                public const uint atvPlay_SelectedState = 4;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: widgetSrcATV.navReturn.Selected
                /// navReturn.Selected
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: widgetSrcATV.atvBack.IconURL
                /// atvBack.Icon URL
                /// </summary>
                public const uint atvBack_IconURLState = 6;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: widgetSrcATV.atvPlay.IconURL
                /// atvPlay.Icon URL
                /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="widgetSrcATV"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal widgetSrcATV(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal widgetSrcATV(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            atvDpad = new MicrosoftTeamsDemo.widgetSrcATV.atvDpad(ComponentMediator, 27);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((MicrosoftTeamsDemo.widgetSrcATV.atvDpad)atvDpad).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((MicrosoftTeamsDemo.widgetSrcATV.atvDpad)atvDpad).RemoveDevice(device);
        }
        ...
        /// <inheritdoc/>
        public void atvBack_Selected(widgetSrcATVBoolInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void atvPlay_Selected(widgetSrcATVBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void navReturn_Selected(widgetSrcATVBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void atvBack_IconURL(widgetSrcATVStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void atvPlay_IconURL(widgetSrcATVStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// ComplexComponent atvDpad
        /// </summary>
        public MicrosoftTeamsDemo.widgetSrcATV.IatvDpad atvDpad { get; private set; }
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "widgetSrcATV", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
