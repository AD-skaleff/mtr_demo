...
namespace MicrosoftTeamsDemo.home
{
    ...
    public partial interface ISourceSelect 
    {
        ...
        /// <summary>
        /// SourceSelect.Visibility Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void SourceSelect_Visibility_fb(SourceSelectBoolInputSigDelegate callback);

        /// <summary>
        /// SourceSelect.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void SourceSelect_Visibility_fb(bool digital);
    }
    ...
    /// <param name="sourceselect">The <see cref="ISourceSelect"/> on which to apply the feedback.</param>
    public delegate void SourceSelectBoolInputSigDelegate(BoolInputSig boolInputSig, ISourceSelect sourceselect);
    ...
    internal partial class SourceSelect : ISourceSelect, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: home.SourceSelect.Visibility_fb
                /// SourceSelect.Visibility
                /// </summary>
                public const uint SourceSelect_Visibility_fbState = 1;
        ...
        /// <inheritdoc/>
        public void SourceSelect_Visibility_fb(SourceSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.SourceSelect_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void SourceSelect_Visibility_fb(bool digital)
        {
            SourceSelect_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
