...
namespace MicrosoftTeamsDemo.home
{
    ...
    public partial interface IwidgetSrcCameras 
    {
        ...
        /// <summary>
        /// widgetSrcCameras.Visibility Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void widgetSrcCameras_Visibility_fb(widgetSrcCamerasBoolInputSigDelegate callback);

        /// <summary>
        /// widgetSrcCameras.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void widgetSrcCameras_Visibility_fb(bool digital);
    }
    ...
    /// <param name="widgetsrccameras">The <see cref="IwidgetSrcCameras"/> on which to apply the feedback.</param>
    public delegate void widgetSrcCamerasBoolInputSigDelegate(BoolInputSig boolInputSig, IwidgetSrcCameras widgetsrccameras);
    ...
    internal partial class widgetSrcCameras : IwidgetSrcCameras, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: home.widgetSrcCameras.Visibility_fb
                /// widgetSrcCameras.Visibility
                /// </summary>
                public const uint widgetSrcCameras_Visibility_fbState = 1;
        ...
        /// <inheritdoc/>
        public void widgetSrcCameras_Visibility_fb(widgetSrcCamerasBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.widgetSrcCameras_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void widgetSrcCameras_Visibility_fb(bool digital)
        {
            widgetSrcCameras_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
